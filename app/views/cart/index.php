...
<?php else : ?>
    ...
    <div class="order">
        <?php foreach ($data as $product_cart) : ?>
            <?php $totalPrice += $product_cart['price'] * $product_cart['count']; ?>
        ...
        <div class="card mb-3 " style="max-width: 900px;">
            <div class="end d-flex justify-content-end justify-content-between">
                ...
                <button type="button" data-toggle="modal" class="btn btn-warning checkout" data-target="#staticBackdrop">Оформить заказ</button>
